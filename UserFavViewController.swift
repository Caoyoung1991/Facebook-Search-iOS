...
class UserFavViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {

    @IBOutlet weak var tbView: UITableView!
    
    @IBOutlet weak var userfavButton: UIBarButtonItem!
    
    var idArray = UserDefaults.standard.array(forKey: "userFavoriteid") as! [String]
    var nameArray = UserDefaults.standard.array(forKey: "userFavoritename") as! [String]
    var imgURLArray = UserDefaults.standard.array(forKey: "userFavoriteurl") as! [String]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        SwiftSpinner.show("loading data...")
        if self.revealViewController() != nil {
            userfavButton.target = self.revealViewController()
            userfavButton.action = #selector(SWRevealViewController.revealToggle(_:))
