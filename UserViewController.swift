...
class UserViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    var tmpfavoriteID = UserDefaults.standard.array(forKey: "userFavoriteid") as! [String]
    ...
    override func viewDidLoad() {
        ...
        if self.revealViewController() != nil {
            userButton.target = self.revealViewController()
        ...
        Alamofire.request("http://sample-env.xyhsmeh2ph.us-west-2.elasticbeanstalk.com/", parameters: ["search": text, "type": "user"]).validate().responseJSON {
            response in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let star = cell.viewWithTag(102) as? UIImageView {
            if flag == true {
...
//    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        tmpfavoriteID = UserDefaults.standard.array(forKey: "userFavoriteid") as! [String]
        tbView.reloadData()
    }
